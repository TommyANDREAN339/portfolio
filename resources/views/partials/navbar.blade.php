    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link  {{ ($title === "Parts") ? 'active' : '' }}" href="/parts">Parts</a>
          </li>
          <li class="nav-item">
            <a class="nav-link  {{ ($title === "Patterns") ? 'active' : '' }}" href="/patterns">Patterns</a>
          </li>
          <li class="nav-item">
            <a class="nav-link  {{ ($title === "Employees") ? 'active' : '' }}" href="/employees">Employees</a>
          </li>
          <li class="nav-item">
            <a class="nav-link  {{ ($title === "Leaves") ? 'active' : '' }}" href="/leaves">Leaves</a>
          </li>
        </ul>
